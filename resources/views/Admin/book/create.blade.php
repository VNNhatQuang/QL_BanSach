                    ...
                    <form action="{{ route('book.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label class="control-label col">Mã sách:</label>
                                    <div class="col">
                                        <input type="text" name="masach" class="form-control" autofocus>
                                    </div>
                                </div>
                                @error('masach')
                                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="col">
                                        <input type="number" min="1" value="1" name="sotap" class="form-control">
                                    </div>
                                </div>
                                @error('sotap')
                                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <div class="col">
                                        <img width="200" src="" style="display: none;" id="imgPreview">
                                    </div>
                                </div>
                            </div>
                        </div>
